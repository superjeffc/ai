...
2. The entire resume MUST fit on exactly ${pageLabel} and look complete and balanced:
   - For multi-page targets (e.g., "2 PAGES"), plan a clean page split by adding a page-break block before a major section (like '<div style="page-break-before: always; break-before: page;"></div>'). Plan the content distribution so sections split logically rather than breaking mid-sentence.
